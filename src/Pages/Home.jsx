...
const TECH_STACK = ["React JS", "Flask", "Python", "JavaScript", "Tailwind CSS", "CSS3", "HTML5", "Bootstrap", "PostgreSQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/yrlnls" },
  // { icon: Linkedin, link: "https://www.linkedin.com/in/tillen-otuoma/" },
  // { icon: Instagram, link: "https://www.instagram.com/yrln_ls/" }
];
